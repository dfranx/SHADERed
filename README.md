...
open source, cross-platform (runs on Windows, Linux and soon macOS - HLSL shaders work on every OS too) and frequently updated with new features. It has many **features** that the competition
is lacking.
